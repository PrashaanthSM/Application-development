...
import './DashboardPage.css'; // Make sure your CSS is updated
...
function Dashboard() {
  ...
  useEffect(() => {
    // Fetch user details or use location state
    const fetchedUserDetails = location.state?.userDetails || {
      name: 'John Doe',
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="main-content">
        ...
        {activeTab === 'profile' && userDetails && <Profile userDetails={userDetails} />}
        {activeTab === 'status' && (
